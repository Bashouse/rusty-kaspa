...
use bascoin_addresses::{Address, Prefix};
// use bascoin_bip32::Prefix;
use bascoin_consensus_core::network::{NetworkId, NetworkType};
use bascoin_consensus_core::tx::{ScriptPublicKey, TransactionOutpoint, UtxoEntry};

use hex;
use bascoin_consensus_core::constants::UNACCEPTED_DAA_SCORE;
use bascoin_txscript::{extract_script_pub_key_address, pay_to_address_script, pay_to_script_hash_script};
...
pub fn script_sig_to_address(script_sig: &[u8], prefix: bascoin_addresses::Prefix) -> Result<Address, Error> {
...
mod tests {
    ...
    use crate::role::*;
    use bascoin_consensus_core::tx::{TransactionId, TransactionOutpoint, UtxoEntry};
    use bascoin_txscript::{multisig_redeem_script, pay_to_script_hash_script};
