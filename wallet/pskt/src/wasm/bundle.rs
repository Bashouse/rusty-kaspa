...
use crate::wasm::pskt::*;
use crate::wasm::utils::sompi_to_bascoin_string_with_suffix;
use bascoin_consensus_core::network::{NetworkId, NetworkIdT};
...
impl PSKB {
    ...
    pub fn display_format(&self, network_id: &NetworkIdT) -> Result<String> {
        ...
        Ok(self.0.display_format(network_id, sompi_to_bascoin_string_with_suffix))
    }
...
mod tests {
    ...
    #[wasm_bindgen_test]
    fn _test_deser() {
        let pskb = "";
        // Deserialize the bundle
