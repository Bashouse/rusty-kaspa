//!
//! PSKT is a crate for working with Partially Signed Bascoin Transactions (PSKTs).
...
//! multiple `PSKT` instances allowing for exchange of Bascoin sweep transactions.
//!
