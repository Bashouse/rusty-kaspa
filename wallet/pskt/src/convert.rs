...
//! the [`bascoin_consensus_client`], [`bascoin_consensus_core`]
//! and [`bascoin_wallet_pskt`](crate) types.
//!
...
use bascoin_consensus_client::{Transaction, TransactionInput, TransactionInputInner, TransactionOutput, TransactionOutputInner};
use bascoin_consensus_core::tx as cctx;
