...
use bascoin_bip32::Error as BIP32Error;
...
pub enum Error {
    ...
    #[error(transparent)]
    NetworkId(#[from] bascoin_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NetworkType(#[from] bascoin_consensus_core::network::NetworkTypeError),
