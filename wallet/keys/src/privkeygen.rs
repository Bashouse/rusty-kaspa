...
/// This class accepts the master Bascoin XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Bascoin master private keys use `bprv` prefix.
///
